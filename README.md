...
│  (DUT nodes)     │          │  (python-can)   │            │  958 cases    │
└─────────────────┘          └────────────────┘            └───────────────┘
...
| 全量回归 | （默认） | 全部 958 用例 + 覆盖率门禁 97% | 958 用例 | ~60s |
...
958 个用例逐文件设计详解见 [docs/test_cases.md](docs/test_cases.md)。
...
| [docs/test_cases.md](docs/test_cases.md) | 958 用例逐文件设计详解（含面试素材） | 测试/面试 |

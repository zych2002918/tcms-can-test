...
[![tests: 794](https://img.shields.io/badge/tests-794%20passed-brightgreen)](#) [![coverage: 98%](https://img.shields.io/badge/coverage-98%25-brightgreen)](#)
<!-- 自证：tests=795 (skipped 1, failures 0, errors 0) coverage=98.00% — 由 scripts/gen_badges.py 依据 JUnit + coverage.json 生成 -->
<!-- badges:end -->

...
_EXT_NOMINAL: dict[str, dict] = {
    "HVAC_CabinStatus": {"CabinTemp": 24.0, "SetTemp": 22.0, "CompressorState": 1, "HvacFaultCode": 0},
    "HVAC_Monitor": {"FilterDirty": 0, "HeaterState": 0, "FreshAirDamper": 80,
                     "CompressorHours": 1200, "HvacPowerKw": 18.5},
    "PIS_PassengerInfo": {"NextStationCode": 3, "PisDisplayState": 0, "NextStopAnnounce": 0,
                          "EmergencyTalkActive": 0, "PassengerIntercom": 0,
                          "PassengerCount": 42, "PisFaultCode": 0},
    "Light_CabinControl": {"CabinLightState": 1, "EmergencyLightActive": 0, "LightBrightness": 80,
                           "LampGroupFault": 0, "LightFaultCode": 0},
    "Fire_Detection": {"SmokeDetectorState": 0, "FireZone": 0, "ExtinguisherReady": 1,
                       "DetectorTestMode": 0, "FireSystemFault": 0},
    "Aux_Converter": {"AuxVoltage": 380.0, "AuxFrequency": 50.0, "AuxLoadPercent": 45,
                      "AuxContactorState": 1, "AuxConverterFault": 0,
                      "AuxInverterTemp": 42.0, "AuxAmbientTemp": 30.0},
    "ATO_Command": {"AtoMode": 1, "AtoAvailable": 1, "AtoWarning": 0, "DoorReleaseSide": 0,
                    "TargetSpeed": 80.0},
    "Bogie_Monitor": {"Axle1Temp": 55, "Axle2Temp": 56, "Axle3Temp": 54, "Axle4Temp": 55,
                      "GearboxTemp": 62, "VibrationLevel": 2.0, "VibrationTrend": 10,
                      "BogieSensorFault": 0},
    "DoorControlRear": {"Door5State": 0, "Door6State": 0, "Door7State": 0, "Door8State": 0,
                        "AllRearDoorsClosed": 1, "RearDoorOpenPermit": 0,
                        "ObstacleDetected": 0, "RearDoorIsolation": 0},
    "Gateway_Status": {"MvbSegmentA": 1, "MvbSegmentB": 1, "WlanLinkQuality": 95,
                       "EtherTrainBackbone": 1, "GatewayFault": 0},
    "Brake_Wsp": {"WheelSpeed1": 0.0, "WheelSpeed2": 0.0, "WheelSpeed3": 0.0, "WheelSpeed4": 0.0,
                  "SlidePercent": 0.0, "WspActive": 0, "WspFault": 0},
    "Traction_Converter": {"ConvTemp": 48, "ConvFaultCode": 0, "TracDisable": 0, "DcLinkVoltage": 1500},
    "Driver_Console": {"MasterController": 0, "CabActive": 1, "EmergencyStopPressed": 0,
                       "DriverKeyPresent": 1},
    "Battery_Charger": {"ChargerState": 1, "ChargerCurrent": 20.0, "ChargerTemp": 28.0,
                        "ChargerFault": 0},
}
